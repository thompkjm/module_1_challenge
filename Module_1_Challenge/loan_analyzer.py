...
print(f"Total Number of Loans: {total_number_loans}")
...
print(f"Loan Total: {total_loans}")
...
new_loan_present_value = present_value_calculator(new_loan.get("future_value"), new_loan.get("remaining_months"), annual_discount_rate)
...
# YOUR CODE HERE!
for each in loans:
    if each["loan_price"] <= 500:
        inexpensive_loans.append(each)
